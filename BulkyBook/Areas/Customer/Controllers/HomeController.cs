...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var productFromDb = _unitOfWork.Product.GetFirstOrDefailt(u => u.Id==id, includeProperties: "category,coverType");
        ...
        [Authorize]
        public IActionResult Deatils(ShoppingCart CartObject)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                ShoppingCart cartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefailt(
            ...
            {
                var productFromDb = _unitOfWork.Product.GetFirstOrDefailt(u => u.Id == CartObject.ProductId, includeProperties: "category,coverType");
